...
import 'package:e_companion/HomeScreen/SideDrawer/Reminder/actions/actions.dart';
import 'package:e_companion/HomeScreen/SideDrawer/Reminder/main.dart';
import 'package:e_companion/HomeScreen/SideDrawer/Reminder/models/index.dart';
...
const String playMusic = 'Attend course';
const String lookAfterPlants = 'Take quiz';
const String walk = 'Assign quiz';
// const String drinkingWater = '';
const String custom = 'Take break';

const remindersIcons = {
  playMusic: Icons.play_circle_fill,
  lookAfterPlants: Icons.question_answer_rounded,
  walk: Icons.question_answer_rounded,
  // drinkingWater: Icons.local_drink,
  custom: Icons.free_breakfast,
};
